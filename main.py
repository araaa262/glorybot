...
if __name__ == "__main__":
    try:
        client_thread = FF_CLIENT(id="4398287199", password="TAI_KIKWN_BY_SPIDEERIO_GAMING_VCKO1")
        client_thread.start()
    except Exception as e:
        logging.error(f"Error occurred: {e}")

        client_thread = FF_CLIENT(id="4400055778", password="rasyaaa_TS372_BY_SPIDEERIO_GAMING_SDF12")
        client_thread.start()
    except Exception as e:
        logging.error(f"Error occurred: {e}")                       
        restart_program()